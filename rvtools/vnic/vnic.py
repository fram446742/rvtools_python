            ...
            if host.config and host.config.network and host.config.network.pnic:
                for nic in host.config.network.pnic:
                    nic_data = {
                        ...
                        'speed': str(nic.linkSpeed.speedMb) if hasattr(nic, 'linkSpeed') and nic.linkSpeed else "",
                        'duplex': str(nic.linkSpeed.duplex) if hasattr(nic, 'linkSpeed') and nic.linkSpeed else "",
                        'mac': nic.mac or "",
                        'switch': "",
                        'uplink_port': "",
                        'pci': nic.pci or "",
