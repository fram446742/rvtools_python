...
class VHostCollector(BaseCollector):
    ...
    def _collect_host(self, host):
        ...
        host_data['in_maintenance_mode'] = str(host.runtime.inMaintenanceMode) if host.runtime else ""
        ...
        vm_summary = summary.runtime.dasHostState.vmCount if summary and summary.runtime else 0
